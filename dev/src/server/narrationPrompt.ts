...
const SEGMENT_TONE: Record<NarrationInput['segment'], string> = {
  A: 'Segment A prefers data over interpretation. Write exactly ONE short sentence — strictly figure-led, no more than ~25 words. State only what happened and the resulting figures; do not explain why, do not editorialize. Example of the right length and density: "Sold $21,780.00 of VTSAX (150 shares, FIFO), realizing a $1,920.00 short-term gain; est. tax $105.78."',
