...
> Sold $231,884.40 of VTSAX with a MinTax method resulting in a $18,445.72 tax impact, $4,443.24 short-term gain, $115,862.25 long-term gain, and a -21.15% shift in portfolio allocation while the fund has returned 29.41% over the trailing 12 months, alongside $13,115.60 of VTIAX with a MinTax method resulting in a $125.91 tax impact, $524.62 short-term gain, and a -1.28% shift in portfolio allocation while the fund has returned 40.09% over the trailing 12 months, and waiting 14 days for lot T-VTIAX-07 offers $47.39 in tax savings, plus $58,016.00 of VBTLX with a MinTax method resulting in a $164.16 tax impact, $684.00 short-term gain, -$2,375.00 long-term gain, and a -4.81% shift in portfolio allocation while the fund has returned 6.42% over the trailing 12 months, and $46,984.00 of VBIRX with a MinTax method resulting in a -$1,094.64 long-term gain, and a -5.15% shift in portfolio allocation while the fund has returned 4.72% over the trailing 12 months, achieving $2,785.64 in losses harvested for an estimated net tax of $18,215.34 at an effective rate of 5.20%.

Worth a look in the separate review pass: this four-fund transaction produces a long, run-on sentence — the model's segment-A "one sentence" instruction doesn't scale well to a multi-fund automated recommendation. Not addressed this session (real output, not a figures bug).
